...
export default function Profile() {
  return (
    <FadeIn className={classes.profileContainer}>
      ...
      <div className={classes.descContainer}>
        ...
        <div className={classes.urlWrap}>
          <a href="https://github.com/jungin7612">
            <img src={github} alt="" className={classes.github} />
          </a>
          <a href="https://www.instagram.com/jungin7612/">
            <img src={insta} alt="" className={classes.insta} />
          </a>
        </div>
      </div>
    </FadeIn>
